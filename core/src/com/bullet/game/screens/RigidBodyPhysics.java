...
import com.bullet.game.screens.BasicCollisionDetection.GameObject;
    ...
    private void createObjects(){
        for (int i = -6; i < 6; i += 2) {
            for (int j = -6; j < 6; j += 2) {
                ...
                btRigidBody.btRigidBodyConstructionInfo info = new btRigidBodyConstructionInfo(mass, null, shape, localInertia);
